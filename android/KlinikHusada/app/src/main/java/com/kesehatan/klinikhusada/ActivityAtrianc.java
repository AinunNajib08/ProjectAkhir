...
public class ActivityAtrianc extends AppCompatActivity {
    ...
    TextView tvAntrian, tvTime, tvSilahkan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loading = new ProgressDialog(ActivityAtrianc.this);
        mcontext = this;
    ...
    public void Timer(){
        ...
        CountDownTimer timer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                tvTime.setText("Kamu Tidak Perlu Mengantri, Silahkan Datang Ke Klinik Kami Sekarang");
                tvSilahkan.setVisibility(View.GONE);
                tvAntrian.setVisibility(View.GONE);
            }
        };
        timer.start();
    }
