...
class Datakunjunganpoli3 extends CI_Controller
{
    ...
    {
        $data["kunjunganpoli3"] = $this->Mkunjungan_pasien->datakunjunganpoli3();
        ...
        $this->load->view("admin/datakunjunganpoli3", $data);
    }
